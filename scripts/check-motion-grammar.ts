...
assert(motionGrammar.version === "6.0.0", "Motion Grammar must carry the V6.0.0 version");
...
const expectedModes = ["build-page", "recommend", "compose", "implement", "review", "contribute"];
assert(
