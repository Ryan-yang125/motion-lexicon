...
console.log(`Public artifact check passed: V3.1 catalog, llms files, pricing, and registry expose ${registryComponents.length} components and ${installablePrimitiveEntries.length} installable primitives.`);
