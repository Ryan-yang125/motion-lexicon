...
export function ValueFlash({
  ...
  return (
    <motion.span
      initial={false}
      animate={{ transform: `scale(${reduced ? 1 : flashing ? 1.05 : 1})` }}
          ...
          <motion.span
            ...
            initial={
              reduced
                ...
                : {
                    opacity: 0,
                    transform: `translate3d(0, ${direction === "down" ? "-0.85em" : "0.85em"}, 0)`,
                    filter: "blur(5px)",
                  }
            }
            animate={{
            ...
            exit={
              reduced
                ...
                : {
                    opacity: 0,
                    transform: `translate3d(0, ${direction === "down" ? "0.7em" : "-0.7em"}, 0)`,
                    filter: "blur(4px)",
                    transition: DROP,
                  }
            }
            ...
            <motion.svg
              ...
              initial={
                reduced
                  ...
                  : {
                      opacity: 0,
                      transform: `translate3d(0, ${direction === "up" ? "0.3em" : "-0.3em"}, 0) scale(0.4)`,
                    }
              }
              animate={{
                opacity: 1,
