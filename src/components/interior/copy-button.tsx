...
export function CopyButton({
  ...
  return (
    <motion.button
      ...
      whileTap={
        disabled || reduced ? undefined : { transform: "translate3d(0, 1px, 0)" }
      }
      transition={CELL}
      ...
      <span className="grid size-[14px] shrink-0" aria-hidden="true">
        <motion.svg
          ...
          animate={{
            ...
            transform: `scale(${status === "idle" ? 1 : 0.92})`,
          }}
          transition={fade}
        >
        ...
        <motion.svg
          ...
          animate={{
            ...
            transform: `scale(${status === "copied" ? 1 : 0.92})`,
          }}
          transition={fade}
        >
          <motion.path
        ...
        <motion.svg
          ...
          animate={{
            ...
            transform: `scale(${status === "error" ? 1 : 0.92})`,
          }}
          transition={fade}
        >
