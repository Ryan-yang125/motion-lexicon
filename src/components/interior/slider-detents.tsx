...
export function SliderDetents({
  ...
  return (
    <div className={`w-full select-none ${className}`}>
      {showValue ? <div className="mb-2.5 flex items-baseline justify-between gap-3">
        <span
          id={labelId}
      ...
      >
        <div className="pointer-events-none absolute inset-x-0 top-[9px] h-[10px] overflow-hidden rounded-[5px] bg-stone-200 dark:bg-white/15">
          ...
          >
            <div
              className="absolute inset-0 origin-left bg-stone-800 dark:bg-stone-100"
        ...
        >
          <div className="absolute inset-y-0 left-0 right-0">
            <motion.div
              ...
              style={{ left: `${percent * 100}%`, marginLeft: -THUMB / 2 }}
              initial={false}
              animate={{ transform: `scale(${dragging ? 1.08 : 1})` }}
