...
export function DitherRevealCard({
  ...
  return (
    <button
      ...
      className={`group relative isolate min-h-[220px] w-full overflow-hidden rounded-[18px] bg-[#EEECE5] text-left shadow-[0_1px_2px_rgba(41,41,41,0.06),0_18px_50px_-34px_rgba(41,41,41,0.45)] outline-none focus-visible:ring-2 focus-visible:ring-[#4568FF] focus-visible:ring-offset-2 focus-visible:ring-offset-[#F4F2EC] dark:bg-[#1D1D1A] dark:focus-visible:ring-[#93B0FF] dark:focus-visible:ring-offset-[#151513] ${className}`}
    >
      <canvas
        ref={canvasRef}
        aria-hidden
