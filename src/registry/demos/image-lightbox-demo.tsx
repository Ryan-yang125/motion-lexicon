...
const works: readonly ImageLightboxItem[] = [
  {
    ...
    meta: "A–01",
    art: (
      <div aria-hidden="true" className="relative size-full overflow-hidden bg-[#ededed]">
        <div className="absolute inset-y-[8%] left-[11%] w-[32%] rounded-t-full bg-[#171717]" />
  ...
  },
  {
    ...
    meta: "A–02",
    art: (
      <div aria-hidden="true" className="relative size-full overflow-hidden bg-[#e5e5e5]">
        <div className="absolute -left-[12%] top-[18%] aspect-square w-[66%] rounded-full bg-[#525252]" />
        <div className="absolute inset-x-0 bottom-[18%] h-px bg-[#292929]/22" />
        <div className="absolute bottom-[12%] right-[9%] h-[58%] w-[22%] rounded-full bg-[#737373] mix-blend-multiply" />
      </div>
    ),
  },
  {
    ...
    art: (
      <div aria-hidden="true" className="relative size-full overflow-hidden bg-[#171817]">
        <div className="absolute left-[10%] top-[17%] size-[36%] rounded-full border border-[#525252]/50 bg-[#171717]/18 " />
        <div className="absolute inset-y-[14%] right-[16%] w-px bg-white/18" />
        <div className="absolute bottom-[19%] right-[9%] h-px w-[48%] bg-[#525252]/70" />
      </div>
    ),
  },
  {
    ...
    meta: "B–01",
    art: (
      <div aria-hidden="true" className="relative size-full overflow-hidden bg-[#d4d4d4]">
        <div className="absolute inset-[12%_18%] -rotate-3 bg-[#fafafa] shadow-[0_24px_42px_-24px_rgba(41,41,41,0.65)]" />
        <div className="absolute left-[24%] top-[29%] h-px w-[38%] bg-[#292929]/55" />
        <div className="absolute bottom-[18%] right-[17%] size-[23%] rounded-full bg-[#525252] mix-blend-multiply" />
      </div>
    ),
  },
  {
    ...
    art: (
      <div aria-hidden="true" className="relative size-full overflow-hidden bg-[#e5e5e5]">
        <div className="absolute bottom-[-12%] left-[28%] h-[112%] w-[30%] rotate-[28deg] rounded-full bg-[#737373]" />
        <div className="absolute right-[13%] top-[18%] size-[30%] rounded-full border border-[#292929]/20 bg-white/28 " />
  ...
  },
  {
    ...
    art: (
      <div aria-hidden="true" className="relative size-full overflow-hidden bg-[#e5e5e5]">
        ...
        <div className="absolute bottom-[11%] right-[12%] size-[52%] rounded-full border border-white/50 bg-[#a3a3a3]/80 mix-blend-multiply" />
