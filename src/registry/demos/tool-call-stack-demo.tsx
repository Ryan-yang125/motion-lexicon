...
export function ToolCallStackDemo({ locale = "en" }: DemoLocaleProps = {}) {
  return <div role="group" aria-label={demoText("tool-call-stack", locale)} className="mx-auto w-full max-w-[460px]"><ToolCallStack label={demoValue(locale, "执行记录", "Execution log")} calls={locale === "zh" ? [
