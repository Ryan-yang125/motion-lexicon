...
function Scene({ detailed = false, locale }: { detailed?: boolean; locale: Locale }) {
  return (
    <div className={`relative size-full overflow-hidden ${detailed ? "bg-[#d4d4d4]" : "bg-[#ededed]"}`}>
      <div className="absolute -left-10 bottom-[-46px] size-44 rounded-full bg-[#525252]" />
      <div className={`absolute right-[-28px] top-[-34px] size-40 rotate-12 rounded-[36px] ${detailed ? "bg-[#171717]" : "bg-[#737373]"}`} />
      <div className="absolute left-[28%] top-[22%] h-[56%] w-[47%] rounded-[10px] border border-white/60 bg-white/75 p-4 shadow-[0_6px_8px_-6px_rgba(28,25,23,.65)]">
