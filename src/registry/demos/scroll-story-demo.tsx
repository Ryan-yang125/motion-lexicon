...
function Scene({ tone, title, index, locale }: { tone: string; title: string; index: string; locale: Locale }) {
  return (
    <div className="mx-auto w-full max-w-[230px] rounded-[16px] border border-white/55 bg-white/88 p-4 shadow-[0_4px_8px_-6px_rgba(28,25,23,.7)] dark:border-white/10 dark:bg-[#1F1F1C]">
