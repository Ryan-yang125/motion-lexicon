...
export function MagneticActionDemo({ locale = "en" }: DemoLocaleProps = {}) {
  return (
    <div role="group" aria-label={demoText("magnetic-action", locale)} className="relative grid w-full max-w-[420px] place-items-center overflow-hidden rounded-[18px] bg-[#DDD7CD] px-6 py-12 dark:bg-[#292825]">
