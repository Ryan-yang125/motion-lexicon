...
const nodes: readonly NetworkGlobeNode[] = [
  { id: "sf", label: "San Francisco", latitude: 37.77, longitude: -122.42, value: "28 ms", color: "#171717" },
  { id: "ldn", label: "London", latitude: 51.51, longitude: -0.13, value: "41 ms", color: "#525252" },
  { id: "sin", label: "Singapore", latitude: 1.35, longitude: 103.82, value: "33 ms", color: "#737373" },
];
