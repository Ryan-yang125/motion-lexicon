        ...
        <div className="w-full max-w-[330px] space-y-3">
          ...
          >
            <div className="overflow-hidden rounded-[12px] bg-stone-900 p-4 text-white dark:bg-stone-100 dark:text-stone-900">
              <div className="mb-6 flex items-center justify-between"><StatusPill>v4.1</StatusPill><span className="text-[9px] opacity-50">{textFor(locale, "8 月 11 日", "11 AUG")}</span></div>
              <strong className="block text-[15px]">{textFor(locale, "原子动效，重新完成", "Primitives, rebuilt")}</strong>
              <p className="mt-1 text-[10px] opacity-60">{textFor(locale, "40 个独立的 React 动效交互。", "40 independent React motion interactions.")}</p>
            </div>
          </RevealPrimitive>
